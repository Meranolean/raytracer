...
const std::string PATH = "/home/meranolean/code/shad-cpp0/raytracer/my_trais/";

TEST_CASE("Shading parts", "[raytracer]") {
    CameraOptions camera_opts(640, 480);
    RenderOptions render_opts{1};
    CheckImage("shading_parts/scene.obj", "shading_parts/scene.png", camera_opts, render_opts, PATH + "shading.png");
}
...
TEST_CASE("Triangle", "[raytracer]") {
    ...
    RenderOptions render_opts{1};
    CheckImage("triangle/scene.obj", "triangle/scene.png", camera_opts, render_opts, PATH + "triangle.png");
}
...
TEST_CASE("Triangle2", "[raytracer]") {
    ...
    camera_opts.look_to = std::array<double, 3>{0.0, 0.0, 0.0};
    RenderOptions render_opts{1};
    CheckImage("triangle/scene.obj", "triangle/black.png", camera_opts, render_opts, PATH + "triangle2.png");
}
...
TEST_CASE("Mirrors", "[raytracer]") {
    ...
    CheckImage("mirrors/scene.obj", "mirrors/result.png", camera_opts, render_opts, PATH + "mirrors.png");
}
...
TEST_CASE("Box with spheres", "[raytracer]") {
    ...
    RenderOptions render_opts{4};
    CheckImage("box/cube.obj", "box/cube.png", camera_opts, render_opts, PATH + "box_spheres.png");
}
...
TEST_CASE("Deer", "[raytracer]") {
    ...
    RenderOptions render_opts{1};
    CheckImage("deer/CERF_Free.obj", "deer/result.png", camera_opts, render_opts, PATH + "deer.png");
}
